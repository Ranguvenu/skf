...
define(['jquery', 'block_configurable_reports/timeme'], function($, TimeMe) {
    ...
    console.log('This is from config reports================================');
    var trackModule2 = {
        timeme: function() {
            TimeMe.initialize({
            ...
            setInterval(function() {
                ...
                document.cookie = "time_timeme_cr =" + timeSpentOnPage + ";path=/";
                console.log("document.cookie :::",document.cookie)
            }, 500);
            document.cookie = "time_timeme_cr = 0 ;path=/;expires=Thu, 01 Jan 1970 00:00:01 GMT;";
        }
    };
    return trackModule2;
});
