...
/**
 * Weekly session columns
 */
class plugin_weeklysessions extends pluginbase {
    /**
     * Weekly session column init function
     */
    public function init() {
        $this->fullname = get_string('weeklysessions', 'block_learnerscript');
        $this->type = 'undefined';
        $this->form = true;
        $this->reporttypes = ['weeklysessions'];
    }
    /**
     * Weekly session column summary
     * @param object $data Weekly session column name
     */
